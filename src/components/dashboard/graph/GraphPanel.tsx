...
export function GraphPanel({
  ...
  const handleRelationshipConfirm = useCallback(
    async (type: Enums<"relationship_type">) => {
  ...
  const handleRelationshipUpdate = useCallback(
    async (relationshipId: string, type: Enums<"relationship_type">) => {
      try {
   ...
   */
  const handleNoteEntityUpdate = useCallback(
    async (noteId: string, entityId: string, newType: Enums<"relationship_type">) => {
      try {
