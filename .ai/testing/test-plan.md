...
- **Zakres:**
  ...
  - **Integracja warstwy usługowej:** Testowanie `*.service.ts` w połączeniu z _testową bazą danych Supabase_ w celu weryfikacji poprawności zapytań SQL i logiki biznesowej.
